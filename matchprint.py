...
counter=0
for file in [files for file in os.listdir("SOCOFing/Real")][:1000]:
    ...
    matches=cv2.FlanneBasedMatcher({'algorithm':1,'trees':10},{}.knnMatch(descriptors_1, descriptors_2, k=2))
    match_points=[]
